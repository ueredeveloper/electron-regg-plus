...
class ObjectView {
	...
	render() {
        ...
        <p>
        Art. 1º Transferir os termos de direito de uso de água subterrânea ao <b><span class="us-nome"></span></b>,
        CPF/CNPJ n.º <b><span class="us-cpf-cnpj"></span></b>,
        concedido ao <span class="inter-us-anterior-nome"></span>,
        CPF/CNPJ n.º <span class="inter-us-anterior-cpf-cnpj"></span>,
        ...
        com a mesma finalidade, tendo a seguinte característica:
        </p>
        </div>
        `;
