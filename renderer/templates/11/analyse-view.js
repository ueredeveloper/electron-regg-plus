...
class AnalyseView {
	...
	render() {
		let innerHTML = `
			...
			<p></p>
			<p>4. Outorga anterior: <span class="inter-despacho-tipo">Despacho</span>/SRH nº
			...
			<p>Figura 03: Reserva explotável e balanço hídrico do subsistema <span class="inter-sistema"></span>.</p>
			...
			<p>14. A documentação solicitada foi atendida e sustenta a solicitação de transferência de outorga de direito de uso de água
			subterrânea.</p>
	...
	update(documento, interferencia) {
		...
		Array.from(document.getElementsByClassName('inter-uh')).forEach(el => {
			el.innerHTML = new InterferenciaModel().getUnidadeHidrografica(interferencia) || 'XXX';
		});
