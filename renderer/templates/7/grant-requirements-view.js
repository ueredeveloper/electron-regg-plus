...
class GrantRequirementsView {
    ...
    render() {
        ...
        <p>&nbsp;</p>
        <p>
            <strong>Art. 11. Revoga-se o <span class="inter-despacho-tipo">Despacho</span>/SRH nº
            <span class="inter-despacho-numero"></span>, de <span class="inter-despacho-data"></span>.</strong>
        </p>
        <p>&nbsp;</p>
        <p>
            Art. 12. Esta outorga entra em vigor na data de sua publicação.
        </p>
