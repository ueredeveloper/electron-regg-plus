...
const OUT_FETCH_BY_USER  = path.join(__dirname, 'json', 'document-fetch-by-user-id.json')
...
class DocumentService {
  ...
  async fetchByUserId(userId) {
    ...
    if (Array.isArray(data) && data.length > 0) writeJson(OUT_FETCH_BY_USER, data[0])
